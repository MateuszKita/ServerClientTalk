...
public class ClientTalk extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(ClientTalk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            Thread sendThread = new Thread((Runnable) sendToServer);
            sendThread.start();
            ReceiveFromServer recieveThread = new ReceiveFromServer(sock);
            Thread receiveThread = new Thread((Runnable) recieveThread);
            receiveThread.start();
